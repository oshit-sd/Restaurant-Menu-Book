                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="old_password" id="oldPass" class="form-control" onblur="oldPassCheck('<?php echo $pass->id; ?>')" required placeholder="Password">
                                        </div>
                                        <div id="msgReqO"></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    function oldPassCheck(id) {
        $.ajax({
            ...
            success: function(data)
            {
                if(data.suc){
                    $('#status').val('suc');
                    $("#msgReqO").html("Old password is match!!").css("color","green");
                }
                else if(data.err){
                    $('#status').val('err');
                    $("#msgReqO").html("Old password do not match!!").css("color","red");
                }
            }
        });
    }
    ...
    function changePass(id)
    {
        ...
        if(oldPass == ""){
            $("#msgReqO").html("Old password is required").css("color","red");
            return false;
        }else{ $("#msgReqO").html(""); }
