			...
			<ul class="breadcrumb">
				<li class="active btn btn-primary btn-xs" style="background: #1D2841;"> 
					<a href="#" style="color: #ddd;">
						<i class="icon-plus3"></i> Update Category
					</a>
				</li>
			</ul>
		</div>
						...
						<form id="updateForm" class="form-horizontal form-validate-jquery" method="patch">
							...
							<fieldset class="content-group">
				                ...
				                <div class="form-group">
				                  <label class="control-label col-lg-4">Category Name <span class="text-danger">*</span></label>
				                  <div class="col-lg-8">
				                    <input type="text" required name="fld_category" required value="{{ $editData->fld_category }}" class="form-control">
				                  </div>
				                </div>
