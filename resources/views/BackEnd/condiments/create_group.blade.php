...
@section('content')
    ...
    <!-- Request Url -->
        <input type="hidden" id="Url" value="/condimentsGroup">
        ...
        <div class="col-lg-7">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select name="fld_condiments_id[]" required data-placeholder="Select Condiments..." multiple="multiple" class="select">
            ...
            @if ($getData)
                @foreach ($getData as $data)
                    ...
                    <tr>
                        ...
                        <td style="width: 30%;">
                            @foreach($data->condiments as $condiment)
                        ...
                        <td class="text-center"  style="width: 10%;">
                            ...
                            <ul class="icons-list">
                                <li class="text-primary-600">
                                    <a href="{{ url('/condimentsGroup/'.$data->id.'/edit') }}" class="labelSize2 btn btn-primary" data-popup="tooltip" title data-original-title="Edit_Data"><i class="icon-pencil7"></i></a>
                                </li>
