			...
			<ul class="breadcrumb">
				<li class="active btn btn-primary btn-xs" style="background: #1D2841;">
					<a href="#" style="color: #ddd;">
						<i class="icon-plus3"></i> Update Condiments
					</a>
				</li>
			</ul>
		</div>
						...
						<form id="updateForm" class="form-horizontal form-validate-jquery" method="patch">
							...
							<fieldset class="content-group">
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" name="fld_condiment_name" value="{{ $editData->fld_condiment_name }}" required placeholder="Name" class="form-control">
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" name="fld_price"  value="{{ $editData->fld_price }}" placeholder="Price" class="form-control">
