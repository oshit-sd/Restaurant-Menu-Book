			...
			<ul class="breadcrumb">
				<li class="active btn btn-primary btn-xs" style="background: #1D2841;"> 
					<a href="#" style="color: #ddd;">
						<i class="icon-plus3"></i> Update Table
					</a>
				</li>
			</ul>
		</div>
						...
						<form id="updateForm" class="form-horizontal form-validate-jquery" method="patch">
							...
							<fieldset class="content-group">
				                ...
				                <div class="form-group">
				                  <label class="control-label col-lg-4">Table Name <span class="text-danger">*</span></label>
				                  <div class="col-lg-8">
				                ...
				                <div class="form-group">
				                  <label class="control-label col-lg-4">Table Sections Name <span class="text-danger">*</span></label>
				                  <div class="col-lg-8">
				                    <select name="fld_section_id" class="form-control">
				                    	
		                            @foreach($getSectionData as $section)
		                              <option value="{{ $section->id }}"
									    @if ($editData->fld_section_id == $section->id) selected="selected"
									    @endif
									    >{{ $section->fld_name }}</option>
		                            @endforeach
		                          </select>
				                  </div>
				                </div>
