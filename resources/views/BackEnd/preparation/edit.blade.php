			...
			<ul class="breadcrumb">
				<li class="active btn btn-primary btn-xs" style="background: #1D2841;">
					<a href="#" style="color: #ddd;">
						<i class="icon-plus3"></i> Update Preparation
					</a>
				</li>
			</ul>
		</div>
						...
						<form id="updateForm" class="form-horizontal form-validate-jquery" method="patch">
							...
							<fieldset class="content-group">
								...
								<div class="form-group">
									<label class="control-label col-lg-4">Preparation Name <span class="text-danger">*</span></label>
									<div class="col-lg-8">
								...
								<!-- Form Input Field -->
								<div class="form-group">
									<label class="control-label col-lg-4">Price <span class="text-danger"></span></label>
									<div class="col-lg-8">
										<input type="text" required name="fld_price" required value="{{ $editData->fld_price }}" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<input type="number" name="fld_position" value="{{ $editData->fld_position }}" placeholder="Position" class="form-control">
									</div>
								</div>
