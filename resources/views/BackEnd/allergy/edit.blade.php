			...
			<ul class="breadcrumb">
				<li class="active btn btn-primary btn-xs" style="background: #1D2841;">
					<a href="#" style="color: #ddd;">
						<i class="icon-plus3"></i> Update Allergy
					</a>
				</li>
			</ul>
		</div>
						...
						<form id="updateForm" class="form-horizontal form-validate-jquery" method="patch">
							...
							<fieldset class="content-group">
								...
								<div class="form-group">
									<label class="control-label col-lg-4">Allergy Name <span class="text-danger">*</span></label>
									<div class="col-lg-8">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<textarea name="fld_description" placeholder="Description" class="form-control" rows="4">{{ $editData->fld_description }}</textarea>
									</div>
								</div>
