			...
			<ul class="breadcrumb">
				<li class="active btn btn-primary btn-xs" style="background: #1D2841;"> 
					<a href="#" style="color: #ddd;">
						<i class="icon-plus3"></i> Update User
					</a>
				</li>
			</ul>
		</div>
						...
						<form id="updateForm" class="form-horizontal form-validate-jquery" method="patch">
							...
							<fieldset class="content-group">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<input type="text" name="name" value="{{ $editData->name }}" required placeholder="Name" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<input type="password" name="fld_password" required placeholder="New Password" class="form-control">
									</div>
								</div>
