...
@section('content')
            ...
            <!-- Request Url -->
            <input type="hidden" id="Url" value="/UserEntry">
              ...
              <td class="text-center" style="width: 10%;">
                ...
                <ul class="icons-list">
                  <li class="text-primary-600">
                    <a href="{{ url('/UserEntry/'.$data->id.'/edit') }}" class=" linka fancybox fancybox.ajax labelSize2 btn btn-primary" data-popup="tooltip" title data-original-title="Edit_Data"><i class="icon-pencil7"></i></a>
                  </li>
